...
namespace chess {
	...
	constexpr auto BISHOP_RATING = 3100_rt;
	constexpr auto KNIGHT_RATING = 3000_rt;
	constexpr auto PAWN_RATING = 1000_rt;
	constexpr auto PAWN_ADVANCEMENT_RATING = 10_rt;
	constexpr auto ATTACKED_PIECE_RATING = 20_rt;
	constexpr auto PAWN_ISLAND_PENALTY = -2_rt;
	constexpr auto PIECE_PROXIMITY_FACTOR = 0.01;
	constexpr auto DESTINATION_SQUARE_PROXIMITY_FACTOR = 0.01;
	constexpr auto CASTLE_RATING = 20_rt;
